...
![](/creators.vrchat.com/images/worlds/udon-networking-pickup-object-sync.png)
...
![](/creators.vrchat.com/images/worlds/slider-program-variables.png)
...
![](/creators.vrchat.com/images/worlds/udon-networking-synced-slider.png)
...
![](/creators.vrchat.com/images/worlds/udon-networking-scne.png)
#### 例子：泡泡枪

![](/creators.vrchat.com/images/worlds/udon-networking-bubble-gun-shooting.png)
...
![](/creators.vrchat.com/images/worlds/udon-networking-bubble-gun-graph.png)
...
![](/creators.vrchat.com/images/worlds/ownership-transfer.svg)
## 使用变量（Variables）
...
![](/creators.vrchat.com/images/worlds/udon-networking-network-debug.png)

就是个可网络同步的椅子
您可以在客户端使用 [右键] + [`] + [6] 以列表形式查看每个对象的一些信息：
![](/creators.vrchat.com/images/worlds/udon-networking-networking-debug.png)
