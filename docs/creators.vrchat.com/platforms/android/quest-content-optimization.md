...
Oculus Quest 对虚拟形象上的内容有几个硬性（和软性）限制。您可以查看 [Quest 内容限制](./quest-content-limitations.md)以了解更多信息，以及我们的[虚拟形象性能排名系统](../../avatars/avatar-performance-ranking-system.md)页面以了解有关限制系统运行原理的更多详细信息。
...
这些建议通过我们的[虚拟形象性能排名系统](../../avatars/avatar-performance-ranking-system.md)在技术上强制执行。
...
同样的普遍规则适用于装配在世界中的虚拟形象。请记住，同一个房间中可能有 10 个或更多的玩家，因此您需要非常严格地预算三角面的使用情况。**我们建议您的虚拟形象面数低于 10000 个三角形**。
...
对纹理大小的留意在虚拟形象和世界中都适用，但请记住，您应该减小虚拟形象纹理的大小，因为在单个房间中您将加载多个虚拟形象（但您只会加载一个世界）。
...
您可以在我们的 [Quest 内容限制](./quest-content-limitations.md)页面上阅读有关这些着色器的信息。
