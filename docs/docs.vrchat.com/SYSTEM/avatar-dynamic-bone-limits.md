...
为了清晰起见，该系统是可选的，可以通过一个选项禁用。

<center>

![img](https://cn-nb1.rains3.com/docs-image/controls/avatar-dynamic-bone-limits-1.png)
...
![img](https://cn-nb1.rains3.com/docs-image/controls/avatar-dynamic-bone-limits-2.png)
